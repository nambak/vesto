...
<section class="py-0 mb-16 bg-white">
    <div class="max-w-7xl mx-auto">
        <div class="grid md:grid-cols-2 lg:grid-cols-4">
            <!-- Collection 1 - Ethereal Elegance -->
            <div class="relative bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 h-96 group overflow-hidden">
            ...
            <!-- Collection 2 - Enchanting Styles -->
            <div class="relative bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 h-96 group overflow-hidden">
